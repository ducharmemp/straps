-- tests/run_e2e_http.lua — TRUE end-to-end: the real curl binary talking to
...
--   nvim --headless -l tests/run_e2e_http.lua
...
case("real curl + real socket: SSE answer streams into the transcript", function()
...
case("the request body that crossed the wire is complete, valid JSON", function()
...
local err_server, err_port = start_server(function()
...
local buf_err, text_err = run_session("this will be rejected")

case("real 400 over the wire surfaces status and API message", function()
