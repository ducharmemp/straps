-- tests/run_layers_partial.lua — config-gated layer registration: partial
-- table keeps the other layer's default ON.
--   nvim --headless -l tests/run_layers_partial.lua
...
case("partial layers table: editor off, editor tools absent", function()
...
case("partial layers table: openai left unset stays ON (default true)", function()
